    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, verbose_name='verification status')),
                ('role', models.CharField(choices=[('member', 'пользователь'), ('moderator', 'модератор')], default='member', max_length=20, verbose_name='role')),
                ('avatar', models.ImageField(default='default_avatar.jpg', upload_to='users/avatar/', verbose_name='Аватар')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_code', models.PositiveIntegerField(blank=True, null=True, verbose_name='user code')),
                ('verify_code', models.PositiveIntegerField(verbose_name='verify code')),
